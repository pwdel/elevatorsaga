...
* Thirdly, finding out that the way to move the elevator up and down is actually through the idle function, not the update function, as discussed in [](/notes/mainloop.md)
