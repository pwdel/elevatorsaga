{
    init: function(elevators, floors) {
        ...
        function eachElevatorFunction(elevators, floors){
            ...
            }); // end of idle/main function

        }; // end of eachElevatorFunction

    }, // end of init: function(elevators, floors)

        update: function(dt, elevators, floors) {
            // We normally don't need to do anything here
        } // end of update: function(dt, elevators, floors)
}
